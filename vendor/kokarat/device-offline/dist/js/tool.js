...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        axios.get('/nova-vendor/device-offline').then(function (response) {
            _this.totalOffline = response.data.total_offline;
            _this.list = response.data.device_offline;
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v("Device Offline (" + _vm._s(_vm.totalOffline) + ")")
      ]),
      _vm._v(" "),
      _c(
        "card",
        ...
        [
          _c("table", { staticClass: "table w-full" }, [
            ...
            _c(
              "tbody",
              _vm._l(_vm.list, function(car, index) {
                return _c("tr", [
                  ...
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(_vm._s(car.protocol))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(_vm._s(car.device_id))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(_vm._s(car.device_name))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(_vm._s(car.device_alerts))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(_vm._s(car.last_update_utc))
                  ])
                ])
              }),
              0
