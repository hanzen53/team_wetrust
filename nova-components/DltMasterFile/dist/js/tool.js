...
var update = __webpack_require__(138)("6e5db1d0", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(142);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('https://gpsservice.dlt.go.th/masterfile/getList/0/5000', { headers: { "Authorization": "Basic d2VnbG9iYWw6NzRyakg0aFJaU3JI" } }).then(function (response) {
            _this.masterFileData = response.data.results;
            _this.masterFileCount = response.data.count;
            console.log(_this.masterFileData);
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v("All DLT Master File (" + _vm._s(_vm.masterFileCount) + ")")
      ]),
      _vm._v(" "),
      _c(
        "card",
          ...
          _c("table", { staticClass: "table w-full" }, [
            _c("thead", [
              _c("tr", [
                _c("th", [_vm._v("#")]),
                _vm._v(" "),
                _c("th", [_vm._v("Unit ID")]),
                _vm._v(" "),
                _c("th", [_vm._v("หมายเลขตัวถัง")]),
                _vm._v(" "),
                _c("th", [_vm._v("หมายเลขทะเบียน")]),
                _vm._v(" "),
                _c("th", [_vm._v("ยี่ห้อรถยนต์")]),
                _vm._v(" "),
                _c("th", [_vm._v("ลักษณะรถและประเภทการขนส่ง")])
              ])
            ]),
            _vm._v(" "),
            _c(
              "tbody",
              _vm._l(_vm.masterFileData, function(car, index) {
                return _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(" " + _vm._s(car.unit_id))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(" " + _vm._s(car.vehicle_chassis_no))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(" " + _vm._s(car.vehicle_id))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(" " + _vm._s(car.vehicle_register_type))
                  ]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _vm._v(" " + _vm._s(car.vehicle_type))
                  ])
                ])
              }),
              0
