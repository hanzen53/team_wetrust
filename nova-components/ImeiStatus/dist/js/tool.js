...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchData: function fetchData() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.xsrfHeaderName = "X-CSRFToken";
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://api.wetrustgps.com:7899/api/devices/show/' + this.imei).then(function (response) {
                _this.show = true;
                _this.carDataAPI = response.data;
                _this.lastKnown = response.data.last_know_position[0];
                _this.imei = _this.imei;
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("IMEI Status")]),
      _vm._v(" "),
        ...
        _c("div", { staticClass: "flex border-b border-40" }, [
          ...
          _c("div", { staticClass: "w-3/4 px-8 py-6" }, [
            _c("input", {
              ...
              attrs: {
                placeholder: "ใส่ IMEI ที่ต้องการตรวจสอบ",
                type: "text"
              },
          ...
          _vm._v(" "),
          _c("div", { staticClass: "w-4/4 px-8 py-6" }, [
            _c(
              "button",
              {
      ...
      _vm.show
        ? _c("div", { staticClass: "card overflow-hidden" }, [
            _c("div", { staticClass: "flex border-b border-40" }, [
              _c("pre", { staticClass: "CodeMirror-line" }, [
                _vm._v(_vm._s(_vm.carDataAPI))
              ])
            ])
          ])
        : _vm._e()
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-4/4 px-8 py-6" }, [
