        ...
        <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="POST" action="/sale/update/{{$customer->id}}" enctype="multipart/form-data">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label for="content" class="col-sm-2 control-label">สำเนาบัตรประชาชน   @if($customer->id_card == '') <i class="fa fa-times text-red" aria-hidden="true"></i> @else <i class="fa fa-check text-green" aria-hidden="true"></i> @endif</label>
                            <div class="col-sm-10">
                                <p>
                        ...
                        <div class="form-group">
                            <label for="content" class="col-sm-2 control-label">เล่ม (หน้าจดทะเบียน)   @if($customer->book_1 == '') <i class="fa fa-times text-red" aria-hidden="true"></i> @else <i class="fa fa-check text-green" aria-hidden="true"></i> @endif</label>
                            <div class="col-sm-10">
                                <p>
                                    <input type="file" class="form-control" name="book_1" value="{{$customer->book_1}}">
                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="content" class="col-sm-2 control-label">เล่ม (หน้าเจ้าของรถ)  @if($customer->book_2 == '') <i class="fa fa-times text-red" aria-hidden="true"></i> @else <i class="fa fa-check text-green" aria-hidden="true"></i> @endif</label>
                            <div class="col-sm-10">
                                <p>
                                    <input type="file" class="form-control" name="book_2" value="{{$customer->book_2}}">
                                </p>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
